    ...
    <>
      ...
      <div className={classes.container}>
        <div className={classes.musicLeft}>
          ...
          <h2 className={classes.title} style={{ color: "white", alignItems: "flex-start", justifyContent: "flex-start", fontSize: '30px', paddingTop: "20px" }}>Let the Music Speak</h2>
          ...
          <div className={classes.content} ref={titleRef}>
            {/* <button className={classes.refresh} onClick={refresh}> <RefreshOutlinedIcon /></button> */}
